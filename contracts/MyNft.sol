...
contract MyNFT is ERC721URIStorage {
  ...
  constructor() ERC721 ("SKYWARRIOR", "SKY") {
  ...
  function mintNFT() public {
    ...
    require(newItemId <= totalMintableNft, "Only 50 NFTs can be minted");
    ...
    emit MintedNFT(msg.sender, newItemId);
    // Update your URI!!!
